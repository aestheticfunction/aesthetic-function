...
>
> **Status:** TODO (owner decision pending) — how this repository relates to the current dspack-centered roadmap (active pillar / paused / superseded) has not yet been decided; this line records that the question is open rather than implying active parity with the rest of the ecosystem.
